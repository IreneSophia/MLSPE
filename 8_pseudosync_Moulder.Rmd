...
* "ML_turns_230616.csv" which contains all turn information needed for section sliding
* "ML_indi_230616.csv" which contains the actual synchronisation values for comparison
* "ML_dyad_230616.csv" which contains the actual synchrony values for comparison
...
filename = "ML_indi_st-shuffle_230616.RData"
...
if (!file.exists(filename)) {
  ...
  df = read_csv("ML_turns_230616.csv", show_col_types = F) %>% 
...
df.sync = read_csv("ML_indi_230616.csv", show_col_types = F) %>% 
  separate(
...
filename = "ML_dyad_s-shuffle_230616.RData"
...
if (!file.exists(filename)) {
  ...
  df.dyad = read_csv("ML_dyad_230616.csv", show_col_types = F)
...
df.sync = read_csv("ML_dyad_230616.csv", show_col_types = F) %>% 
